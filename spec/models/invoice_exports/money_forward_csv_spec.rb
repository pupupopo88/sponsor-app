...
RSpec.describe InvoiceExports::MoneyForwardCsv do
  ...
  let(:sponsorship) do
    instance_double(Sponsorship, billing_contact: contact, plan:, booth_assigned: true)
  end
  ...
  describe '#rows' do
    ...
    context 'without a booth' do
      let(:sponsorship) do
        instance_double(Sponsorship, billing_contact: contact, plan:, booth_assigned: false)
      end
